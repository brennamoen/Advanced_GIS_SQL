...
ON	defaultdb.enterprise.parcel_sales.pin = 
	defaultdb.enterprise.parcels_core.pin
WHERE
	defaultdb.enterprise.parcel_sales.sale_value > 200000	AND
		defaultdb.enterprise.parcel_sales.sale_value < 600000	AND
			defaultdb.enterprise.parcels_core.acres_poly > 30;
